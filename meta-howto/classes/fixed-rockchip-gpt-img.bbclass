...
UBOOT          = "u-boot.out"
TRUST          = "trust.out"
GPTIMG_APPEND ?= "earlycon=uart8250,mmio32,0xff160000 earlyprintk swiotlb=1 console=ttyS2,115200n8 rw root=/dev/mmcblk2p7 rootfstype=ext4 rootwait"
#GPTIMG_APPEND ?= "swiotlb=1 console=ttyS2 rw root=/dev/mmcblk2p7 rootfstype=ext4 rootwait"
...
IMAGE_CMD:fixed-rockchip-gpt-img () {
...
create_rk_image () {
	...
	for DTS_FILE in ${KERNEL_DEVICETREE}; do
        # not using basename here breaks arm64 builds
        DTS_FILE=$(basename ${DTS_FILE})
